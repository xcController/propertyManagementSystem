	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                <form role="form" data-toggle="validator" action="inspection?action=inspectionUpdate" method="post">
				<fieldset>
					...
					<div class="form-group">
						<div class="input-group col-md-3">
							...
							<input type="text" class="form-control" value = "${inspection.note}" name="note">
						</div>
                    </div>
