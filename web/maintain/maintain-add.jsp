	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                <form role="form" data-toggle="validator" action="../maintain?action=maintainAdd" method="post">
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="input-group date form_date col-md-3" data-date="" data-date-format="yyyy-mm-dd" data-link-format="yyyy-mm-dd">
							<input class="form-control" name="enddate" type="text" value="" readonly>
							<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
							<span class="help-block with-errors"></span>
						</div>
						<input type="hidden" id="dtp_input2" value="" /><br/>
                    ...
                    <div class="form-group">
                        <div class="input-group col-md-3">
                            ...
                            <input type="text" class="form-control" pattern="^[0-9]+(\.[0-9]{0,2})?$" data-error="请输入有效的价格" name="precost" required>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group col-md-3">
                            ...
                            <input type="text" class="form-control" pattern="^[0-9]+(\.[0-9]{0,2})?$" data-error="请输入有效的价格" name="relcost" >
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group">
