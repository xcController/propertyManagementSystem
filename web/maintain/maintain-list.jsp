...
<div class="navbar navbar-default" role="navigation">
    ...
    <div class="navbar-inner">
        ...
        <a class="navbar-brand" href="index.jsp">  <span>物业管理系统</span></a>
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                                ...
                                <c:forEach var="maintain" items="${maintains}" >
									<tr>
										...
										<td>${maintain.note}</td>
                                        <td class="center">
                                            <a class="btn btn-info" href="maintain?action=toMaintainUpdate&id=${maintain.id}">
                                                <i class="glyphicon glyphicon-edit icon-white"></i>
                                                编&ensp;辑
                                            </a>
                                            <a class="btn btn-danger" href="#" data-href="maintain?action=maintainDelete&id=${maintain.id}" data-toggle="modal" data-target="#myModal">
