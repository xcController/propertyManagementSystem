	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                <form action="admin?action=adminUpdate" method="post" data-toggle="validator">
					...
					<div class="form-group">
						<div class="input-group col-md-4">
							...
							<input type="text" class="form-control" name="note" value="${admin.note}"/>
						</div>
					</div>
                    <div class="form-group">
                        <div class="input-group col-md-3">
                            <label class="control-label" for="perms">权限</label>
                            <input type="text" class="form-control" name="perms" value="${admin.perms}"/>
                        </div>
                    </div>
