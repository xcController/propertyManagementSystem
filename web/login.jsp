...
<body background= 'img/b.jpg' style="background-repeat: no-repeat; background-size:cover; margin: auto;">
<div class="ch-container">
    ...
    <div class="row">
        <div class="well col-md-4 center login-box">
            ...
            <form data-toggle="validator" class="form-horizontal" action="login?action=login"  method="post">
                <fieldset>
