	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                <form role="form" action="notice?action=noticeUpdate" data-toggle="validator" method="POST">
					...
					<div class="form-group">
						...
						<div class="input-group date form_date col-md-3" data-date="" data-date-format="yyyy-mm-dd" data-link-format="yyyy-mm-dd">
							<input class="form-control" name="sdate" type="text" value="${notice.sdate }" readonly required>
					...
					<div class="form-group">
						<div class="input-group col-md-3">
							...
							<input type="text" class="form-control" name="publisher" value="${notice.publisher }" required />
							<span class="help-block with-errors"></span>
						</div>
					</div>
					<div class="form-group">
