	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                <form role="form" data-toggle="validator" action="customer?action=customerUpdate" method="post">
					...
					<div class="form-group">
						<div class="input-group col-md-3">
							...
							<input type="text" class="form-control" name="addr" value="${customer.addr}">
							<span class="help-block with-errors"></span>
						</div>
					</div>		
