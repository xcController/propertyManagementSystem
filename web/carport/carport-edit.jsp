        ...
        <div id="content" class="col-lg-10 col-sm-10">
            ...
            <div>
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="carport?action=carportList">车位信息</a>
                    </li>
                    <li>
                        <a href="#">编辑</a>
                    </li>
                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        ...
                        <div class="box-content">
                            <form role="form" data-toggle="validator" action="carport?action=carportUpdate" method="post">
                                <div class="form-group">
                                    <div class="input-group col-md-3">
                                        <label class="control-label" >车位编号</label>
                                        <input type="text" class="form-control"  readonly="readonly" name="id" value="${carport.id}" required>
                                        <span class="help-block with-errors"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group col-md-3">
                                        <label class="control-label" >出售状态*</label>
                                        <select data-rel="chosen" name="state">
                                            <option value="${carport.state }">${carport.state  }</option>
                                ...
                                <div class="form-group">
                                    <div class="input-group col-md-3">
                                        <label class="control-label">所有者编号</label>
                                        <input type="text" class="form-control" name="ownerid" value="${carport.ownerid}">
                                        <span class="help-block with-errors"></span>
                                    </div>
                                </div>
                                <div class="form-group">
