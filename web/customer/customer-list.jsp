        ...
        <div id="content" class="col-lg-10 col-sm-10">
            ...
            <div>
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="customer?action=customerList">业主信息</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="box-inner">
                        ...
                        <div class="box-content">
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                                <thead>
                                <a class="btn btn-success" href="customer/customer-add.jsp">
                                ...
                                <c:forEach var="customer" items="${customers}" >
									<tr>
										...
										<td>${customer.addr}</td>
										<td class="center">
                                            <a class="btn btn-info" href="customer?action=toCustomerUpdate&accountid=${customer.accountid}">
                                                <i class="glyphicon glyphicon-edit icon-white"></i>
                                                编&ensp;辑
                                            </a>
                                            <a class="btn btn-danger" href="#" data-href="customer?action=customerDelete&accountid=${customer.accountid}" data-toggle="modal" data-target="#myModal">
